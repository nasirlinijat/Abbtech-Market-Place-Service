...
public enum ProductErrorEnum implements BaseErrorService {
    ...
    CATEGORY_NOT_FOUND("CATEGORY_NOT_FOUND-ERROR-0004", "CATEGORY_NOT_FOUND", 400),

    BASKET_NOT_FOUND("BASKET_NOT_FOUND-ERROR-0005", "BASKET_NOT_FOUND", 400),

    ORDER_NOT_FOUND("ORDER_NOT_FOUND-ERROR-0006", "ORDER_NOT_FOUND", 400),

    NOTIFICATION_NOT_FOUND("NOTIFICATION_NOT_FOUND-ERROR-0007", "NOTIFICATION_NOT_FOUND", 400),

    USER_NOT_FOUND("USER_NOT_FOUND-ERROR-0008", "USER_NOT_FOUND", 400);
