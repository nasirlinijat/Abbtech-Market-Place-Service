...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RespExceptionDto> handleProductException(ProductException exception, WebRequest webRequest) {
   ...
   // @ExceptionHandler({Throwable.class})
    public ResponseEntity<RespExceptionDto> handleGeneralException(Throwable throwable, WebRequest webRequest) {
